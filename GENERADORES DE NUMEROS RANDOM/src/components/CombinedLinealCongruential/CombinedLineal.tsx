...
const CombinedLinealScreen: React.FC<CombinedLinealScreenProps> = ({ history }) => {
    ...
    const onMultChange = useCallback(
        ({ target }, id, opt) => {
            ...
            list.forEach(function (component: {id: number, error: string, seed: number, a: number, modulo: number}){
                if(component.id == id){
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid item xl={12} lg={12} md={12} sm={12}>
                                    <Grid container spacing={3} id="mults">
                                        {
                                            componentList.map((item: {id: number, error: string, seed: number, a: number, modulo: number}) => (
                                                <Grid item xl={12} lg={12} md={12} sm={12}>
