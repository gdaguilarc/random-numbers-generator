...
interface InputComponentProps {
	...
	recalculateRandNumber: (multiplierA: number, incrementC: number, modulus: number, seed: number, iterations: number) => void
}
		...
		<Card className={classes.cards}>
			...
			<Box className={classes.content}>
				...
				<Button
					...
					style={{ color: "white" }}
					onClick={() => {
						recalculateRandNumber(multiplierA, incrementC, modulus, seed, iterations);
					}}
				>
					Generar
				</Button>
