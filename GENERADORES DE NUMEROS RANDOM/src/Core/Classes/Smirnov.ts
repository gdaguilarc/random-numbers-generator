...
class Smirnov
    ...
    constructor(
        ...
        this.table = [
            ...
            [0.35560, 0.36866, 0.40925, 0.45562, 0.48893, 0.51872, 0.55500, 0.58042],
            ...
            [0.25578, 0.29472, 0.32733, 0.36571, 0.39201, 0.41644, 0.44637, 0.46750],
    ...
    test(): string{
        ...
        else if(this.alpha == 0.10){
            alphaIndex = 1
        }
        else if(this.alpha == .05){
            alphaIndex = 2
        }
        else if(this.alpha == .02){
            alphaIndex = 3
        }
        ...
        this.seen.sort((n1,n2)=> n1 - n2);

        let d = this.calculateD();
        let dAN = this.table[this.seen.length-1][alphaIndex]

        if(dAN < d)
            return "D = " + d + ", DAN = " + dAN + ". Se rechaza la hipótesis porque D > DAN"
        else
            return "D = " + d + ", DAN = " + dAN + ". Se acepta la hipótesis porque D <= DAN"
    }
}