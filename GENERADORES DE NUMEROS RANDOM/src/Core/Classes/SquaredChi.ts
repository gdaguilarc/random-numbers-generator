...
class SquaredChi extends FitTest implements ISquaredChi {
  seen: number[];
  alpha: number;
  table: number[][];
  ...
  constructor(seen: number[], alpha: number) {
    ...
    this.table = [
      ...
      [9.2364, 11.0705, 12.8325, 15.0863, 16.7496, 20.515],
      [10.6446, 12.5916, 14.4494, 16.8119, 18.5476, 22.4577],
      [12.017, 14.0671, 16.0128, 18.4753, 20.2777, 24.3219],
      [13.3616, 15.5073, 17.5345, 20.0902, 21.955, 26.1245],
      [14.6837, 16.919, 19.0228, 21.666, 23.5893, 27.8772],
      [15.9872, 18.307, 20.4832, 23.2093, 25.1882, 29.5883],
      [17.275, 19.6751, 21.92, 24.725, 26.7568, 31.2641],
      [18.5493, 21.0261, 23.3367, 26.217, 28.2995, 32.9095],
      [19.8119, 22.362, 24.7356, 27.6882, 29.8195, 34.5282],
      ...
      [24.769, 27.5871, 30.191, 33.4087, 35.7185, 40.7902],
      [25.9894, 28.8693, 31.5264, 34.8053, 37.1564, 42.3124],
      [27.2036, 30.1435, 32.8523, 36.1909, 38.5823, 43.8202],
      [28.412, 31.4104, 34.1696, 37.5662, 39.9968, 45.3147],
      [29.6151, 32.6706, 35.4789, 38.9322, 41.4011, 46.797],
      [30.8133, 33.9244, 36.7807, 40.2894, 42.7957, 48.2679],
      [32.0069, 35.1725, 38.0756, 41.6384, 44.1813, 49.7282],
      [33.1962, 36.415, 39.3641, 42.9798, 45.5585, 51.1786],
      [34.3816, 37.6525, 40.6465, 44.3141, 46.9279, 52.6197],
      [35.5632, 38.8851, 41.9232, 45.6417, 48.2899, 54.052],
      [36.7412, 40.1133, 43.1945, 46.9629, 49.6449, 55.476],
      [37.9159, 41.3371, 44.4608, 48.2782, 50.9934, 56.8923],
      [39.0875, 42.557, 45.7223, 49.5879, 52.3356, 58.3012],
      [40.256, 43.773, 46.9792, 50.8922, 53.672, 59.7031],
      [51.8051, 55.7585, 59.3417, 63.6907, 66.766, 73.402],
      [63.1671, 67.5048, 71.4202, 76.1539, 79.49, 86.6608],
      [74.397, 79.0819, 83.2977, 88.3794, 91.9517, 99.6072],
      [85.527, 90.5312, 95.0232, 100.4252, 104.2149, 112.3169],
  ...
  test(): string {
    ...
    if (X0 < Xva) {
      return (
        ...
        ", Xva = " +
        Xva +
        ". Se acepta la hipótesis porque X0 < Xva"
      );
    } else {
      return (
        "X0 = " +
        ...
        ", Xva = " +
        Xva +
        ". Se rechaza la hipótesis porque X0 > Xva"
      );
    }
  }
}
